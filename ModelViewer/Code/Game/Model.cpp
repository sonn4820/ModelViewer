...
void Model::Render() const
{
	...
	{
		g_theRenderer->BindTexture(m_game->m_diffuseTexture, 0);
		g_theRenderer->BindTexture(m_game->m_normalTexture, 1);
		g_theRenderer->BindTexture(m_game->m_glossTexture, 2);
	...
	if (m_game->m_debugTBN && m_debugVertexBuffer)
	{
